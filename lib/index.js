...
exports.onHook = exports.onInitHook = exports.onAjaxHook = exports.onAjax = exports.init = exports.hooks = void 0;
...
function onHook(event, callback) {
    ...
    if (exports.hooks[event] instanceof Array) {
        exports.hooks[event].push({ fn: callback, args: args });
    }
}
