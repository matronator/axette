...
exports.onHook = exports.onInitHook = exports.onAjaxHook = exports.noFlashURL = exports.onAjax = exports.init = exports.hooks = exports.Hooks = void 0;
...
function init(ajaxClass) {
    ...
    exports.hooks.onInit.forEach(function (hook) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    init();
                    exports.hooks.onAjax.forEach(function (hook) {
                        if (hook.fn instanceof Function) {
                            hook.fn.apply(hook, hook.args);
                        }
                    });
...
exports.onInitHook = onInitHook;
function onHook(event, callback) {
    var args = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args[_i - 2] = arguments[_i];
    }
    return exports.hooks.addHook(event, { fn: callback, args: args });
}
exports.onHook = onHook;
var axette = { init: init, onAjax: onAjax, hooks: exports.hooks, onHook: onHook, noFlashURL: noFlashURL };
